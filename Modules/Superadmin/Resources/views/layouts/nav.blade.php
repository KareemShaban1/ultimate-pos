        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'popup-post') class="active" @endif><a href="{{action('\Modules\Superadmin\Http\Controllers\SuperadminSettingsController@editPopupPost')}}">@lang('superadmin::lang.PopupPost')</a></li>
