    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                {!! Form::number('package_expiry_alert_days', $settings['package_expiry_alert_days'] ?? 5, ['class' => 'form-control','placeholder' => __('superadmin::lang.package_expiry_alert_days'), 'required']); !!}
            </div>
            </div>
        </div>
        ...
        <div class="col-xs-4">
            <div class="form-group">
                <label>
                    {!! Form::checkbox('enable_business_based_username', 1, (int)($settings['enable_business_based_username'] ?? 0), 
