...
<body>
	<div>
		<div class="table-responsive" style="margin-left: 20px;">
			<table class="table table-bordered" id="payroll-view" style="width:50%; direction:rtl">
				<tr>
					<td colspan="3">
				...
				<tr>
					<td colspan="2" style="width: 50% !important;">
						...
						<div style="width: 30% !important;float: right;">
							...
							<small>
								(
								{{@num_format($payroll->essentials_duration)}}
						...
						@forelse($allowances['allowance_names'] as $key => $value)
												...
												<div style="width: 20% !important;float: right;">
													@if(
															!empty($allowances['allowance_types'][$key])
					...
					<td colspan="2" style="width: 50% !important;">
						...
						@forelse($deductions['deduction_names'] as $key => $value)
												...
												<div style="width: 20% !important;float: right;">
													@if(
															!empty($deductions['deduction_types'][$key])
				...
				<tr>
					<td colspan="3" style="text-align: right;">
						<div
							style="width: 43% !important;float: right;padding-right: 49px">
							<span class="display_currency"
								data-currency_symbol="true">
				...
				<tr>
					<td colspan="3">
						<strong>@lang('essentials::lang.in_words'):</strong>
						{{ucfirst($final_total_in_words)}}
					</td>
				</tr>
				<tr>
					<td colspan="3">
						...
						<table class="table bg-gray table-slim">
							...
							@forelse($payroll->payment_lines as $payment_line)
														...
														<tr>
															...
															<td>{{ $payment_line->payment_ref_no }}
															</td>
